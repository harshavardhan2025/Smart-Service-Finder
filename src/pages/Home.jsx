          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
              <div>
                ...
                <WorkerCarousel sortBy="rating" flat={true} searchedLocation={searchedLocation} userCoords={userCoords} excludeEmail={myWorkerEmail} />
              </div>
              <div style={{ borderTop: "1px solid var(--border-color)", paddingTop: "18px", marginTop: "6px" }}>
                <h3 style={{ fontSize: "16px", fontWeight: 800, color: "var(--text-primary)", margin: "0 0 10px 0" }}>
                  💸 Best Value Picks
                </h3>
                <WorkerCarousel sortBy="price" flat={true} searchedLocation={searchedLocation} userCoords={userCoords} excludeEmail={myWorkerEmail} />
              </div>
            </div>
          </div>
