  ...
  return (
    ...
    <div className="premium-card" style={{ marginBottom: "40px", overflow: "hidden" }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <div>
            ...
            <p style={{ margin: 0, fontSize: "13px", color: "var(--text-muted)", maxWidth: "480px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
              ...
              <FaMapMarkerAlt style={{ color: "var(--primary)", flexShrink: 0 }} /> {location} {!isLoggedIn && " (Guest Preview)"}
        ...
        <FaChevronDown style={{ fontSize: "14px", color: "var(--text-muted)", transition: "transform 0.2s", transform: open ? "rotate(180deg)" : "none" }} />
...
function UserDashboard() {
  ...
  const statusLabel = (status) => {
    ...
    const map = {
      ...
      "Rejected":  { text: "Worker declined",           cls: "status-rejected" },
      ...
      <div className="dashboard-content" style={{ maxWidth: "1200px", margin: "0 auto", padding: "32px 20px" }}>
        ...
        <div className="greeting-banner">
          ...
          <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
            ...
            <span className="greeting-badge" style={{ display: "inline-flex", alignItems: "center", gap: "6px" }}><FaUserCircle /> Customer Account</span>

            <span className="greeting-badge" style={{ display: "inline-flex", alignItems: "center", gap: "6px" }}><FaWallet /> Wallet: ₹{isLoggedIn ? wallet : "0"}</span>
        ...
        <div className="quick-actions-row">
          ...
          <Link to="/" className="quick-action-tile" id="qa-book">
            ...
            <span className="tile-icon"><FaTools /></span>
          ...
          <Link to="/my-bookings" className="quick-action-tile" id="qa-bookings">
            ...
            <span className="tile-icon"><FaClipboardList /></span>
          ...
          <Link to="/plans-offers" className="quick-action-tile" id="qa-plans">
            ...
            <span className="tile-icon"><FaTag /></span>
          ...
          <Link to="/payment" className="quick-action-tile" id="qa-wallet">
            ...
            <span className="tile-icon"><FaCreditCard /></span>
        ...
        {isMobile && (
          ...
          <div className="premium-card" style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
              ...
              <div style={{ width: "48px", height: "48px", borderRadius: "12px", background: "linear-gradient(135deg, #eab308 0%, #f97316 100%)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "20px", color: "white", flexShrink: 0, boxShadow: "0 4px 10px rgba(234, 179, 8, 0.25)" }}><FaTag /></div>
        ...
        <div className="premium-card" style={{ 
          ...
          <h3 style={{ margin: "0 0 4px 0", fontSize: "18px", color: "var(--text-main)", display: "flex", alignItems: "center", gap: "8px", fontWeight: 800 }}>
            ...
            <FaRobot style={{ color: "var(--primary)" }} /> AI-Recommended Services for You
          ...
          {loading ? (
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "16px" }}>
                ...
                const serviceIconMap = {
                  ...
                  "Packers & Movers": FaBox,
                  "Doctors & Medical": FaUserMd,
                  "Appliance Repair": FaPlug,
                  "Mechanic": FaCogs,
                  "Events": FaCalendarAlt,
                  "Beauty, Salon & Spa": FaSpa
                };
                const ServiceIcon = serviceIconMap[serviceName] || FaTools;
                return (
                  <div
                    key={serviceName}
                    onClick={() => {
                  ...
                  >
                    <div style={{ fontSize: "32px", marginBottom: "10px", color: "var(--primary)", display: "flex", justifyContent: "center" }}>
                      <ServiceIcon />
                    </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "30px" }}>
          ...
          <div className="premium-card" style={{ padding: "24px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "18px" }}>
              ...
              <h3 style={{ margin: 0, fontSize: "17px", fontWeight: 800, color: "var(--text-main)", display: "flex", alignItems: "center", gap: "8px" }}><FaClipboardList style={{ color: "var(--primary)" }} /> Recent Bookings</h3>
            ...
            {!isLoggedIn ? (
              ...
              <div className="empty-state">
                ...
                <span className="empty-state-icon"><FaLock style={{ color: "var(--text-muted)" }} /></span>
              ...
              <div className="empty-state">
                ...
                <span className="empty-state-icon"><FaClipboardList style={{ color: "var(--text-muted)" }} /></span>
          ...
          <div className="premium-card" style={{ padding: "24px" }}>
            ...
            {!isLoggedIn ? (
              ...
              <div style={{ textAlign: "center", padding: "30px 10px", color: "var(--text-muted)" }}>
                ...
                <div style={{ fontSize: "28px", color: "var(--text-muted)", display: "flex", justifyContent: "center", marginBottom: "8px" }}><FaWallet /></div>
                  ...
                  <div key={t._id || t.id} className="dashboard-list-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingBottom: "16px", borderBottom: "1px solid var(--border)" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                      ...
                      <div style={{ width: "40px", height: "40px", borderRadius: "50%", backgroundColor: "var(--border)", display: "flex", justifyContent: "center", alignItems: "center", fontSize: "18px" }}>
                        ...
                        <FaWallet style={{ color: "var(--primary)", fontSize: "16px" }} />
          ...
          <div className="premium-card" style={{ padding: "24px" }}>
            ...
            {!isLoggedIn ? (
              ...
              <div style={{ textAlign: "center", padding: "30px 10px", color: "var(--text-muted)" }}>
                ...
                <div style={{ fontSize: "28px", color: "#eab308", display: "flex", justifyContent: "center", marginBottom: "8px" }}><FaStar /></div>
